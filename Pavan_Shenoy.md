...
This Dev Bootcamp gives me an opportunity to finally start well with the MERN stack and be confident using JavaScript.
Also work on my current Web-Dev projects because this course also teaches auth using bcrypt which i am still figuring out for my Note Taking App. 
